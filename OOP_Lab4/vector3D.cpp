...
vector3D& vector3D::operator+(vector3D& objVector3D)
{
...
double vector3D::operator*(vector3D& objVector3D)
{
	return (a * objVector3D.a + b * objVector3D.b + c * objVector3D.c);
}
double vector3D::operator*(Triad& objVector3D)
{
	return (a * objVector3D.getA() + b * objVector3D.getB() + c * objVector3D.getC());
}

double vector3D::angleBetweenVectors(Triad& objVector3D)
{
...
double vector3D::getLength(Triad& objVector3D) const
{
